	...
	var SimpleTable = (function (_React$Component) {
	    ...
	    _createClass(SimpleTable, [{
	        ...
	        value: function componentWillReceiveProps(nextProps) {
	            ...
	            if (nextProps.filter.length > 0 && nextProps.rows.length > 0) displayRows = (0, _filteringJsx2["default"])(nextProps.rows, nextProps.filter);
	        ...
	        value: function componentWillMount() {
	            ...
	            if (this.props.filter.length > 0 && this.props.rows.length > 0) displayRows = (0, _filteringJsx2["default"])(this.props.rows, this.props.filter);
	            this.setState({ displayRows: displayRows });
