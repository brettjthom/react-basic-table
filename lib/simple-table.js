	        ...
	        value: function render() {
	            ...
	            var headers = this.props.columns.map(function (header, index) {
	                if ($component.props.sort.indexOf(index) == -1) {
	                    ...
	                    return _react2['default'].createElement(
	                        'th',
	                        { key: "header" + index, style: $component.props.hideColumns.indexOf(index) != -1 ? { display: "none" } : {}, onClick: $component.sortColumn.bind($component, index) },
	                        header
	                    );
	                }
	            });
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(_pagingJsx2['default'], { numPages: this.state.numPages, page: this.state.page, setPage: this.setPage.bind(this) })
	            );
	        }
	    }]);
	    ...
	    _createClass(SimpleTablePaging, [{
	        ...
	        value: function render() {
	            ...
	            for (i = 1; i <= this.props.numPages; i++) {
	                ...
	                if (lastNumberAdded !== null && lastNumberAdded !== i - 1) pagingNumbers.push(_react2['default'].createElement(
	                    'li',
